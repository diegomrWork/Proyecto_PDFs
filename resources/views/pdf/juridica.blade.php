...
<head>
    <meta charset="UTF-8">
    <title>Cartas Persona Jurídica</title>
    <style>
...
<body>
    ...
    <p>El Comprador, <span class="uppercase bold">{{ $datos['juridica']['nombre_empresa'] }}</span> con RUC N° {{ $datos['juridica']['ruc'] }}, debidamente representado por <span class="uppercase">{{ $datos['juridica']['nombre_representante'] }}</span>, identificado con {{ $datos['juridica']['tipo_doc_representante'] }} N° {{ $datos['juridica']['dni_representante'] }} según partida N° {{ $datos['juridica']['partida'] }} del Registro de Personas Jurídicas de <span class="uppercase">{{ $datos['juridica']['provincia_registral'] }}</span>.</p>
    ...
    <div style="text-align: justify">
        <p>Yo, <span class="uppercase">{{ $datos['juridica']['nombre_representante'] }}</span> identificado con {{ $datos['juridica']['tipo_doc_representante'] }} N° {{ $datos['juridica']['dni_representante'] }}, en calidad de Apoderado de <span class="uppercase">{{ $datos['juridica']['nombre_empresa'] }}</span>, con RUC N° {{ $datos['juridica']['ruc'] }}, con partida N° {{ $datos['juridica']['partida'] }} Del Registro de Personas Jurídicas de <span class="uppercase">{{ $datos['juridica']['provincia_registral'] }}</span>. Otorgo amplio poder a {!! $apoderadosRegistral !!}, para que en mi representación suscriba el Formato de Inmatriculación, Formato Notarial de Cambio de Características, Declaración de Tipo de Uso y cualquier documento que sea necesario para la Inmatriculación del Vehículo con N° de Serie: {{ empty($datos['vehiculo']['serie_chasis']) ? '__________________' : $datos['vehiculo']['serie_chasis'] }} y Nº de Motor: {{ empty($datos['vehiculo']['motor']) ? '__________________' : $datos['vehiculo']['motor'] }}.</p>
    </div>
